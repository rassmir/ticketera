            ...
            <div class="row">
                ...
                <div class="col-lg-6 d-flex align-items-center justify-content-center">
                    <div class="container p-36 pt-64 pb-64 main-content mt-48 bg-white" style="max-width:550px">
                        ...
                        <input type="text" class="form-control mt-20 ob" data-type="text" data-msj="Ingre un correo electrónico" placeholder="Correo" name="email">
                        <input type="password" class="form-control mt-16 ob" data-type="text" data-msj="Ingre una contraseña" placeholder="Contraseña" name="password">
